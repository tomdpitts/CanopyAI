...
class SolarContextTrainer:
    ...
    Objective:
    If I rotate the image by Theta, the predicted sun vector
    ...
    def train_step(self, images):
        """
        images: Batch of orthomosaic crops (B, 3, 512, 512)
        """
...
# Example Dataset (Just loads raw images, NO LABELS)
class RawOrthoDataset(Dataset):
    def __init__(self, image_dir):
        patterns = ["*.tif", "*.png", "*.jpg"]
        self.files = []
        for p in patterns:
    ...
    def __getitem__(self, idx):
        # Load random crop or resized full ortho
        # Implementation details omitted
        return torch.randn(3, 512, 512)  # Dummy return
...
if __name__ == "__main__":
    ...
    # Add parent directory to path to find prototypes.solar_adapter
