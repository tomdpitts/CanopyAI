...
image = (
    ...
    .add_local_dir(
        ...
        ignore=["*.tif", ".git", "__pycache__", "venv*", "data/", "won003*"],
    )
)
...
def train_solar_df_modal(
    ...
    from prototypes.train_solar_deepforest import SolarDetectionDataset, collate_fn
...
def main(run_name: str = "romeo_solar"):
